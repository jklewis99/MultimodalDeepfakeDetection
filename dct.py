...
parser.add_argument('input', type=str, default=None, help=r"Folder containing all of the landmark folders (ex. path\to\video_id)")
parser.add_argument('output', default=None, help="Location to save 1D dct landmark sequences")
parser.add_argument('-seq-size', type=int, default=24, help="Maximum size of sequence (default 24)")
    ...
    for subfolder in subfolders:
        ...
        for video_id in file_list:
            ...
            for landmark in landmarks:
                landmark_output_path = create_directory(os.path.join(args.output, subfolder, video_id, landmark))
                landmark_dct_seq(input_path, video_id, landmark, landmark_output_path, args.seq_size)
